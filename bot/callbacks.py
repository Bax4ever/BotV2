...
from services.moralis_api import get_multiple_token_prices_moralis_scoreboard  # we’ll define next
import time
...
async def handle_about(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    ABOUT_TEXT = (
        ...
        "BundleTracker scans Ethereum tokens and wallet portfolios to show:\n"
        ...
        "📂 *GitHub:* [BundleTracker on GitHub](https://github.com/Bax4ever/BundleTracker)\n"
        "📬 *Contact:* @Baxiks"
    )
...
def check_if_user_called(user_id: str, token_address: str) -> bool:
    try:
